with open(r'C:\Users\Paulo H Parreira\.gemini\antigravity\scratch\platform\modules\wms\js\cadastros.js', 'r', encoding='utf-8') as f:
    lines = f.readlines()

with open(r'C:\Users\Paulo H Parreira\.gemini\antigravity\scratch\platform\modules\wms\js\cadastros.js', 'w', encoding='utf-8') as f:
    f.writelines(lines[:513])
    f.write('''
// ===========================================
