...
window.buscarNotasFiscais = function () {
    const filtros = {
        ...
        notaIni: document.getElementById('nfeNotaIni')?.value,
        notaFim: document.getElementById('nfeNotaFim')?.value,
        pedidoIni: document.getElementById('nfePedidoIni')?.value,
        pedidoFim: document.getElementById('nfePedidoFim')?.value,
