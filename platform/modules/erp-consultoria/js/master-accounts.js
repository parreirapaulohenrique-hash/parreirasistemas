window.MASTER_ACCOUNTS = [
  ...
  { "codigo": "2.1",    "descricao": "BANCO DO BRASIL C.C.60638-3 FILIAL PALMAS" },
  { "codigo": "2.4",    "descricao": "ITAU C.C.98669-0 FILIAL PALMAS" },
  { "codigo": "2.9",    "descricao": "CONTA PERDA/ROUBO E BONIFICAÇÃO FILIAL" },

  { "codigo": "4.0",    "descricao": "TESOURARIA FILIAL PORTO" },
  { "codigo": "4.1",    "descricao": "BANCO DO BRASIL C.C.61105-0 FILIAL PORTO" },
  { "codigo": "4.4",    "descricao": "MERCADO PAGO PIX FILIAL PORTO" },
  { "codigo": "4.9",    "descricao": "CONTA PERDA/ROUBO E BONIFICAÇÃO FILIAL" },

  { "codigo": "91",     "descricao": "CARTÃO ENDERED 5099+4596+6933+8072 - ESCRITORIO" },
  ...
  { "codigo": "1.1",    "descricao": "Receita com Vendas" },
  { "codigo": "1.1.01", "descricao": "Receita em Dinheiro" },
  { "codigo": "1.1.01", "descricao": "Receita em Cartão (Crédito e Débito)" },
  { "codigo": "1.1.01", "descricao": "Receita de Cheque A Vista" },
  { "codigo": "1.1.01", "descricao": "Receita de Cheque Pré" },
  { "codigo": "1.1.01", "descricao": "Recebimento de Carteira (Notinha)" },
  { "codigo": "1.1.01", "descricao": "Recebimento de Boletos" },
  { "codigo": "1.1.01", "descricao": "Recebimento em Depósito e Dep. PIX" },
  { "codigo": "1.1.02", "descricao": "Recebimento Cheque Devolvido" },
  { "codigo": "1.5",    "descricao": "Receita de Garantias" },
  { "codigo": "1.2.01", "descricao": "RECEITA EM DINHEIRO" },
  { "codigo": "1.2.02", "descricao": "RECEITA EM MERCADORIA" },

  // ── Custo de Aquisição (seção 3) ────────────────────────────────────────────
  { "codigo": "HEADER", "descricao": "Custo de Aquisição" },
  { "codigo": "2.1",    "descricao": "Despesa Com Custo de Aquisição" },
  { "codigo": "2.1.01", "descricao": "FORNECEDORES DE MERCADORIAS REVENDA" },
  { "codigo": "2.1.02", "descricao": "ADIANT. FORNEC. MERCA. REVENDA" },
  { "codigo": "2.1.03", "descricao": "TRANSPORTADORA MERCA. REVENDA" },
  { "codigo": "2.1.04", "descricao": "OUTROS CUSTOS DE MERC.REVENDA" },
  { "codigo": "2.1.05", "descricao": "TRANSFE DE MERCAD REVENDA MATRIZ" },

  { "codigo": "2.2",    "descricao": "Inadimplência e Perdas" },
  { "codigo": "2.2.01", "descricao": "CONTAS PERDIDAS/NÃO PAGAS" },
  { "codigo": "2.2.02", "descricao": "BOLETOS DESCONTADOS DEVOLVIDOS" },
  { "codigo": "2.2.03", "descricao": "CHEQUES DEVOLVIDOS" },
  { "codigo": "2.2.04", "descricao": "BOLETOS DESCONTADOS DEVOLVIDOS" },
  { "codigo": "2.2.05", "descricao": "PERDA,  ROUBO  E  DETERIORAÇÃO" },

  { "codigo": "2.3",    "descricao": "Impostos" },
  { "codigo": "2.3.02", "descricao": "IRPJ (SE ESTIVER NO CMV)" },
  { "codigo": "2.3.03", "descricao": "CSSL (SE ESTIVER NO CMV)" },
  { "codigo": "2.3.04", "descricao": "COFINS (SE ESTIVER NO CMV)" },
  { "codigo": "2.3.05", "descricao": "PIS (SE ESTIVER NO CMV)" },
  { "codigo": "2.3.06", "descricao": "ICMS – Normal (SE ESTIVER NO CMV)" },
  { "codigo": "2.3.07", "descricao": "SUBSTITUIÇÃO TRIBUTARIA SAÍDA (TARE)" },
  { "codigo": "2.3.08", "descricao": "SUBSTITUIÇÃO TRIBUTÁRIA NA ENTRADA" },
  { "codigo": "2.3.09", "descricao": "FUNDO DESENVOLVIMENTO ECONOMICO (TARE)" },
  { "codigo": "2.3.11", "descricao": "Impostos Parcelado" },

  { "codigo": "HEADER", "descricao": "Total dos Custos" },
  { "codigo": "HEADER", "descricao": "Receita Operacional Bruta" },

  // ══════════════════════════════════════════════════════════════════════════════
  // SEÇÃO 4 — Despesas Operac. Fixas e Variáveis
  // ══════════════════════════════════════════════════════════════════════════════
  ...
  // ══════════════════════════════════════════════════════════════════════════════
  // SEÇÃO 5 — Receitas Não Operacionais Totais
  // ══════════════════════════════════════════════════════════════════════════════
  { "codigo": "HEADER", "descricao": "Receitas Não Operacionais Totais" },

  // ── 5.1 Receita de Empréstimo ─────────────────────────────────────────────────
  ...
  // ══════════════════════════════════════════════════════════════════════════════
  // SEÇÃO 6 — Despesas Não Operacional
  // ══════════════════════════════════════════════════════════════════════════════
  { "codigo": "HEADER", "descricao": "Despesas Não Operacional" },

  // ── 6.1 EMPRÉSTIMO / FINANCIAMENTO ───────────────────────────────────────────
  ...
  // ── 6.3 INVESTIMENTO EM IMOBILIZADOS ─────────────────────────────────────────
